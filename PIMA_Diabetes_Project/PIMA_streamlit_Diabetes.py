...
with tab1:
    ...
    with st.sidebar:
        ...
        st.write("Adjust the sliders or type values to set patient metrics.")
        ...
        def slider_with_input(label, min_val, max_val, default_val, step=1):
            ...
            st.slider(label, min_val, max_val, st.session_state[slider_key], step, key=slider_key, on_change=on_slider_change)
...
with tab2:
    ...
    st.image("insulin_imputation_comparison.png", caption="Distribution of Insulin before and after KNN Imputation")
    ...
    st.image("Pregnancies_imputation_comparison.png", caption="0 for Pregnancies is a valid data point, while 0 for other features is not.")
